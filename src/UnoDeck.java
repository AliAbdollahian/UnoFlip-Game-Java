...
public class UnoDeck {
    ...
    /**
     * This method for returning card to the deck
     * @return Card returned to deck
     */
//    public void returnToDeck(UnoCard card){
//
//        return  (UnoCard) this.deck.add(this.deck.size() + 1);
//    }
