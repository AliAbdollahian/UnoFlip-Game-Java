SYSC3110 Fall 2023 Project - Uno Flip card game! Milestone 4 Version 1.0; 08/12/2023
...
- UnoDeck.java: Holds the deck of cards and discard pile for the game with shuffling and add/remove methods
- UnoPlayer.java: Class containing the players of the games scores, names, and hand
...
- UnoGameState.java: Contains the state of the game.
...
Milestone 4
- Solely finished Functionality Implementation: Undo, Redo & Replay.
- Worked on documentation and code quality.
...
Milestone 4
- Updated readme file
- Solely finished Functionality Implementation: Serialization & DeSerialization
- Worked on documentation and code quality.


Running Instrctions:
- Re-enter the players information when loading the Game, it has to be the exact information.
...
___________
- Images are not shown in the jar file, only. In order to see the images of all cards, please run the java files and refer to the attached "Our Game Display" image.
